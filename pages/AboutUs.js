          ...
          <div>
               ...
               <div className='container-fluid abouthead mb-3 mt-3' data-aos='fade-up' data-aos-delay='100' data-aos-duration='500'>
                    ...
                    <div className='row h-100'>
                         ...
                         <div className='col-lg-4 text-center text-light my-auto headtext text-uppercase'>About Us</div>
                         <div className='col-lg-4'></div>
                    </div>
               </div>
                    ...
                    <div className='container' data-aos='fade-up' data-aos-delay='200' data-aos-duration='1000'>
                         <div className='row bg-white'>
                              <div className='col-lg-6 text-center mt-5'>
                                   <img src='assets/img/aboutus_risposta.jpeg' className='img-responsive rounded w-100 bs1 my-auto' alt='' />
                              </div>
