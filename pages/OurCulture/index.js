       ...
       <div>
            <div className='container-fluid casestudieshead mt-3 mb-3' style={{ height: '75vh' }} data-aos='fade-up' data-aos-delay='100' data-aos-duration='500'>
                 ...
                 <div className='row h-100'>
                      ...
                      <div className='col-md-4 text-center text-light my-auto headtext text-uppercase'>Our Culture</div>
                      <div className='col-md-4'></div>
                 </div>
            </div>
                      ...
                      <div className='row my-5'>
                           ...
                           <div className='col-md-10 card'>
                                <div className='row' style={{ paddingLeft: '0px' }}>
                                     <div className='col-md-6 h-50' style={{ paddingLeft: '0px' }}>
                                          <img className='w-100' src='/assets/img/ocm.jpg' alt='' />
                                     </div>
