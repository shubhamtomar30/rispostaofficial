...
const Leadership = () => {
     ...
     return (
          <div>
               ...
               <section id='team' className='team section-bg my-5'>
                    <div className='container'>
                         ...
                         <div className='row'>
                              ...
                              <div className='col-lg-9 col-md-6 d-flex align-items-stretch' data-aos='fade-up' data-aos-delay='200' data-aos-duration='1000'></div>
                              ...
                              <div className='col-lg-6 col-md-6 d-flex align-items-stretch' data-aos='fade-up' data-aos-delay='200' data-aos-duration='1000'></div>
                              <div className='col-lg-3 col-md-6 d-flex align-items-stretch' data-aos='fade-up' data-aos-delay='200' data-aos-duration='1000'>
                                   <div className='member'>
                                        <div className='member-img'>
                              ...
                              <div className='col-lg-3 col-md-6 d-flex align-items-stretch' data-aos='fade-up' data-aos-delay='200' data-aos-duration='1000'>
                                   <div className='member'>
                                        ...
                                        <div className='member-info'>
                                             <h4>Rudra Pratap Singh Tomar</h4>
                                             <span>Customer Success</span>
                                        </div>
                                   </div>
                              </div>
                              ...
                              <div className='container-fluid'>
                                   <div className='row'>
                                        <div className='col d-flex align-items-stretch' data-aos='fade-up' data-aos-delay='200' data-aos-duration='1000'>
                                             <div className='member'>
                                                  <div className='member-img'>
               ...
               {/* <div className='container my-5'>
                    <div className='row'>
                         ...
                         <div className='col-md-4'>
                              <img src='assets/img/sai.png' className='img-responsive w-100' alt='' />
                         </div>
                         <div className='col-md-6 p-5'>
                              <p className='text-justify'>A seasoned supply chain leader focused on driving real business value by applying cutting edge technologies to business processes. Proven track record of growing business in product & client based organizations in senior business-critical roles, strategizing with the world's leading retailers, manufacturers and distributors on ways to maximize their business results while improving the lives of assosciates. Proficient in speaking both business and IT languages, translate and customize business aims into IT road-maps. Extensively worked in India, Europe, US, APAC & Australia and South Africa.</p>
                         </div>
                         <div className='col-md-1'></div>
                    </div>
               </div> */}
